...
src/contexts/ingestion/
  ...
  infrastructure/  configuración, planificador, normalización MIME (HU-02) y adaptadores: mongo/, imap/, memory/, resilience/ (retry + circuit breaker), normalization/ (puerto de HU-03).
