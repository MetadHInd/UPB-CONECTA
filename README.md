...
Este repositorio implementa, por ahora, **HU-01 (SCRUM-13): Conexión programada e idempotente al buzón institucional recolector** — el primer eslabón del pipeline de ingesta (EP-01), base de todo lo demás: sin ingesta no hay clasificación, sin clasificación no hay feed, sin feed no hay notificaciones.

El resto del backlog (12 épicas, 57 historias de usuario, ver la Especificación de Requerimientos y el Product Backlog del proyecto) vive en Jira. El **Sprint 1** activo agrupa, además de HU-01, las historias que comparten su mismo riesgo técnico — ingesta y arquitectura verificable:
...
| HU-53 | Aislamiento del dominio verificable y sustituibilidad de los adaptadores |
...
src/contexts/ingestion/
  ...
  infrastructure/  configuración, planificador y adaptadores: mongo/, imap/, memory/.
